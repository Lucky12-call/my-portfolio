        ...
        <div className=" mt-10 md:mt-0">
          ...
          <div className="flex items-center gap-5 mt-10">
            ...
            <div className="flex items-center flex-wrap gap-5 m-2">
              ...
              <SiRedux className="h-6 w-6 md:h-6 md:w-8 lg:h-12 lg:w-12 text-purple-400 hover:scale-110 transition-transform" />

              <SiTailwindcss className="h-6 w-6 md:h-6 md:w-8 lg:h-12 lg:w-12 text-blue-700 hover:scale-110 transition-transform" />

              <SiReactrouter className="h-6 w-6 md:h-6 md:w-8 lg:h-12 lg:w-12 text-blue-600 hover:scale-110 transition-transform" />
