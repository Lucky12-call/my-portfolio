...
const Footer = () => {
  return (
    <section className="bg-forth text-white w-full flex flex-col items-center mt-10 md:mt-20">
      ...
      <div className="flex gap-5 m-5 items-center">
        <a href="https://www.linkedin.com/in/lochan-kumar-8334011b0/">
          <IconButton className="bg-transparent">
            <FaLinkedin
              color="#218FEC"
              className="h-6 w-6 sm:h-8 sm:w-8 md:h-10 md:w-10 hover:scale-110 transition-transform "
            />
          </IconButton>
        </a>
      ...
      <p className="mt-5">© 2025 Lochan.dev, All rights reserved.</p>
      <p className="m-2">lk899202@gmail.com</p>
    </section>
  );
};
