      ...
      <div className="w-full md:w-4/5 mx-auto p-5 flex flex-col md:flex-row justify-between">
        ...
        <div className="w-full md:w-1/2 mt-5 md:mt-0">
          ...
          >
            ...
            />
            {errors.name && <h6 className="text-red-600">name is required*</h6>}
            ...
            <div className="glowing-box h-10 md:h-12 w-40 md:w-48">
              <button className="glowing-btn text-sm md:text-base uppercase font-medium text-white">
                send <LuSend className="h-4 md:h-6 w-4 md:w-6" />
              </button>
            </div>
          </form>
        </div>
